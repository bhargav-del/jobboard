...
A lightweight job application pipeline for thoughtful searches. Built as a local-first, dependency-light product experience with a browser build, a portable Windows desktop build, and a scheduled Android APK release.
